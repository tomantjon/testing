		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#hogenthelloworldg-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"hogenthelloworldg-display": {
								"semanticObject": "hogenthelloworldg",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=hogent.helloworldg",
									"url": sap.ui.require.toUrl("hogent/helloworldg")
								}
							}
						}
					}
